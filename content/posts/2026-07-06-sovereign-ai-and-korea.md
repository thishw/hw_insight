...
이번 달 카드 명세서에 찍힌 달러 결제를 세어 봤다. ChatGPT, Claude, 그리고 코딩 도구 몇 개. 다 합치니 매달 수십 달러가 조용히 태평양을 건너가고 있었다.
...
**구멍은 로직, 즉 연산 그 자체다.** AI 가속기 시장에서 엔비디아 점유율은 약 90%로 추정되고, 한국을 포함한 전 세계가 GPU를 사실상 엔비디아 한 곳에 의존한다(위 삼일PwC). 문제는 반도체 시장에서 비메모리(로직)가 메모리의 약 3배 규모라는 점이다. 그런데 과기정통부(2024) 평가 기준, 메모리를 뺀 한국의 고성능·저전력 AI 반도체 기술 수준은 **1위 미국의 60%**에 그친다(위 삼일PwC). 가장 큰 시장에서 가장 뒤처져 있는 것이다.
...
**Q. AI 구독료 좀 나가는 게 그렇게 큰 문제인가? 경상수지는 흑자라며.**

맞다, 지금 당장 나라가 휘청이는 규모는 아니다. 핵심은 절대 액수보다 **방향과 구조**다. 반도체로 번 달러를 AI 서비스로 되돌려보내는 흐름이 매년 커지고, 그게 매달 자동결제되는 '상시 유출'이라는 점이 문제다. 반도체 흑자는 사이클을 타지만, AI 의존은 한번 굳으면 잘 안 풀린다.

**Q. 그냥 잘 만든 미국·중국 AI 쓰면 되지, 굳이 우리 걸 만들어야 하나?**

효율만 보면 사서 쓰는 게 쌀 수 있다. 다만 소버린 AI는 효율이 아니라 '통제권'을 사는 것이다. 딥시크 사례처럼 데이터가 어디로 가는지 통제할 수 없고, 가격·정책·차단을 남이 정한다면, 그건 전기를 100% 수입하는 것과 같은 취약성이다. 전부 자립하자는 게 아니라, 놓치면 안 되는 핵심만이라도 쥐자는 얘기다.
